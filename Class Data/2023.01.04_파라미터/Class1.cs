...
namespace _2023._01._04_파라미터
{
    public class Class1
    {
        public void Parameter()
        {
             ...
             * 지금까지 기본적으로 사용한 매개변수 전달 방식은 값 전달 방식이다.
             ...
             *  
             *  - 반환형 전달 방식(out) : 메서드를 호출하는 쪽에서 선언만 하고, 
             *    초기화 하지 않고 전달하면 메서드 쪽에서 해당 데이터를 초기화해서 넘겨주는 방식이다.
             *    
             *  - 가변형 전달 방식(params) : 1개 이상의 매개변수를 가변적으로 받을 때 매개변수를 선언하면 params 키워드를 붙인다.
