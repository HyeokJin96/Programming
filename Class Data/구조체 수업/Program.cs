...
namespace ConsoleApp5
{
    internal class Program
    {
        ...
        static void WhatIsStructure()
        {
            ...
            myCard.myName = "YHJ";
            myCard.myAge = "27";
            myCard.myAddress = "Koea";

            BusinessCard[] cards = new BusinessCard[5];
            cards[0].myAge = "27";
            cards[0].myName = "YHJ";
            cards[0].myAddress = "Korea";

            Console.WriteLine("제 이름은 {0}이고, 나이는 {1}, 사는곳은 {2}입니다.", myCard.myName, myCard.myAge, myCard.myAddress);

            /**
             * 내장형 구조체
             * 닷넷 프레임워크에서 이미 내장(Built-int)된 구조체 중에서 날짜 처리를 전달하는 DateTime과
            ...
            /**
             * 열거형 형식 사용하기
             * C#애서 열거형(Enumeration) 형식은 기억하기 어려운 상수들을 기억하기 쉬운 이름 하나로 묶어
            ...
            Console.WriteLine("Red -> 어쩔래미 저쩔래미 쿠크루삥뽕");
            Console.WriteLine("Red -> 어쩔래미 저쩔래미 쿠크루삥뽕");
            Console.WriteLine("Red -> 어쩔래미 저쩔래미 쿠크루삥뽕");
            Console.ResetColor();
