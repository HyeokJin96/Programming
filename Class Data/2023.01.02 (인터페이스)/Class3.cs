...
namespace _2023._01._02__인터페이스_
{
    public class 컬렉션
    {
        public void Collection()
        {
             ...
             * 
             * 배열과 컬렉션
             * C#에서 배열(array)과 컬렉션(collesction), 리스트(list)는 학습 레벨에서 동일하게 취급한다.
             * 컬렉션 클래스는 데이터 항목의 집합을 메모리상에서 다루는 클래스로, 문자열 같은 간단한 형태도 있다.
             * 특정 클래스 형식의 집합 같은 복잡한 형태도 있다.
             * 
             * 3가지의 자주 쓰는 컬렉션 소개
             *  - 배열 : 일반적으로 숫자처럼 간단한 데이터 형식을 저장한다.
             *  - 리스트 : 간단한 데이터 형식을 포함한 개체들을 저장한다.
             *  - 사전 : 키와 값의 쌍으로 관리되는 개체들을 저장한다.
             ...
             * 배열은 크기가 고정되어 있어서 새로운 데이터를 추가할 수 없다.
             ...
             * 닷넷에서는 컬렉션과 관련한 여러 클래스를 제공한다. (Stack 클래스, Queue 클래스, ArrayList 등)
             */
