...
namespace _2023._01._02__인터페이스_
{
    public class 개체_지향_프로그래밍
    {
        public void ObjectOrientedProgramming()
        {
             ...
             * 캡슐화(Encapsulation) 기능을 제공한다. 개체에는 다음과 같은 세 가지 개념이 있다.
             *  - (is something) 무엇이 된다.
             *  - (has data) 데이터를 가진다.
             *  - (perform action) 기능을 수행한다.
             *  
             ...
             * 다향성은 변신 로봇처럼 다양한 형태를 가질 수 있는 능력이다.
             * 
             * 추상화
             ...
             * 필드는 꽁꽁 숨기는 것이 가장 좋다. 즉, 부품 역할을 하는 필드는 가루약을 캡슐에 넣어서 관리하는 것처럼
             * 프로그래밍에서도 필드를 꽁꽁 숨기는 개념이 바로 캡슐화이다.
             * 캡슐화는 구조화된 데이터 개체 값 또는 상태를 숨겨서 권한이 없으면 접근하지 못하도록 차단한다.
             * 캡슐화의 또 다른 의미는 연관된 자료구조와 메서드를 한 테두리로 묶는 것이다.
             * 원칙은 필드는 private이고 public으로 외부에 공개할 때는 속성을 사용하는 것이다.
             * 
             * 상속
